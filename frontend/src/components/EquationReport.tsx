    ...
    <div>
      ...
      <Card>
        <ul className="text-sm list-disc pl-6 space-y-1 font-mono">
          ...
          <li>Customers Next Month = Customers + New Customers − Churned Customers</li>
          <li>MRR = Customers × Average Revenue Per Customer</li>
          <li>Subscriber LTV = [Average Revenue Per Customer × (1 − Operating Expense %)] / Churn Rate</li>
          <li>Gross Profit = MRR × (1 − Operating Expense %)</li>
          <li>Monthly Cash Flow = Gross Profit − Fixed Costs − Marketing Spend</li>
          <li>NPV = ∑ Cash Flow / (1 + WACC / 12)<sup>n</sup> − Initial Investment</li>
        </ul>
      </Card>
    </div>
  );
